...
document.addEventListener('deviceready', function() {
  	...
  	db.transaction(function(tx) {
  		tx.executeSql('CREATE TABLE IF NOT EXISTS Countries (id, sortname, name)');

  		var query = "INSERT INTO Countries (id, sortname, name) VALUES (?,?,?)";

		

		this.forEach(function (countries) {
